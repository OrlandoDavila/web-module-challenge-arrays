...
To save you from having to count the items above, you can assume that length of originalFlavors is 31. You may also want to test your function 
...
function copy(newcopy, originalFlavors){
     newcopy = [...originalFlavors];
    return newcopy;
}

console.log(copy('broFlavor', originalFlavors));
